 ...
 */
public class NormalLoadAssociation {
	...
	public static void main(String[] args) {
		...
		Request normalLoad = new Request();
		...
		try { 
			//Open file
		    WritableWorkbook book= Workbook.createWorkbook(new File("outputData/outputData_Normal.xls")); 
		    ...
		    for(int i=0; i<requestList.size(); i++){
				...
				normalLoad.request(init, requestFileName, i%refreshTime);
